			...
			<div id="token-legend" class="postbox">
				...
				<div class="inside">
					...
					<strong>%series_description%</strong><br />
						<em><?php _e('Will display the description for the series', 'organize-series'); ?></em><br /><br />
					<strong>%full_navigation%</strong><br />
						<em><?php _e('Will display a full navigation of the series as numbers', 'organize-series'); ?></em><br /><br />
